...
- `brain-skill/001-send-api-for-parallel-enrichment.md` for `type: decision`
- `brain-skill/2025-05-26.md` for `type: session`
- `brain-skill/langgraph-reducers.md` for `type: concept`
